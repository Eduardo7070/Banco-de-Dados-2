...
--E
SELECT nomeFornecedor, AVG(valorProduto) 'Media dos Produtos' FROM tbFornecedor
...
--H
SELECT nomeFornecedor, AVG(valorProduto)'Média dos preços dos produtos'  FROM tbFornecedor
	INNER JOIN tbProduto ON tbFornecedor.idFornecedor = tbProduto.idFornecedor
	GROUP BY nomeFornecedor
	ORDER BY [Média dos preços dos produtos]

--I
SELECT nomeProduto, SUM(valorTotalVenda) 'Soma das Vendas' FROM tbProduto
